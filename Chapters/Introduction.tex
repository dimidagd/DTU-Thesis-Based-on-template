...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{Europe-Ship-Safety.jpg}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{Distribution-of-Incidents.jpg}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1.0\textwidth]{munin_shore_satellite_autonomous_ship_control_robotics.JPG}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1.0\textwidth]{aptiv.png}
