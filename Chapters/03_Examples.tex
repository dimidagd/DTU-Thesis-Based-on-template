...
\label{fig:foursubfiguress}
\end{figure}

Referring to the figure as a whole \cref{fig:foursubfiguress} or to an individual sub figure \cref{fig:foursub1} is done the normal way with \texttt{\textbackslash cref\{\}} commands.
